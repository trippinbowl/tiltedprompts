...
export default async function SkillsLibrary() {
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="mb-6">
                <h1 className="text-3xl font-display font-bold mb-2">OpenClaw Skills</h1>
                <p className="text-muted-foreground">Actionable `.md` logic files that grant your internal agents specific capabilities.</p>
            </div>
            ...
            {!error && displayAssets.length === 0 && (
                <div className="p-12 text-center border border-dashed border-border rounded-2xl bg-secondary/5">
                    <h3 className="text-xl font-bold mb-2">No Setup Skills Found</h3>
                </div>
            )}
